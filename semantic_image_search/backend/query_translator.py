...
class QueryTranslator:
    ...
    Translates natural language queries into optimized CLIP image captions.
    """
    ...
    def __init__(self):
        try:
            if not Config.OPENAI_API_KEY:
                ...
                raise ValueError("OPENAI_API_KEY is required for QueryTranslator")
...
Respond with only the rewritten caption.
    ...
    def translate(self, user_query: str) -> str:
        """
        Translate natural language query into optimized CLIP caption.
        
        Args:
            user_query: Natural language search query from user
            
        Returns:
            Optimized caption string for CLIP similarity search
            
        Raises:
            ValueError: If query is empty or invalid
            SemanticImageSearchException: If LLM translation fails
        """
...
def translate_query(user_query: str) -> str:
    """
    Convenience function for query translation using singleton instance.
    
    Args:
        user_query: Natural language search query
        
    Returns:
        Optimized CLIP caption string
    """
